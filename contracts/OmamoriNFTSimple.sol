...
/**
 * @title OmamoriNFTSimple
 * @notice Minimal ERC-721 contract for Omamori tablets with external rendering
 * @dev Ultra-minimal version for HyperEVM deployment
 */
contract OmamoriNFTSimple is ERC721, Ownable {
    ...
    /**
     * @notice Base64 encoding (simplified)
     */
